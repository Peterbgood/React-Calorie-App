export const foodItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '🍫 Mints', calories: 25 },
      { name: '🌋 Kiss', calories: 15 },
      { name: '🍨 Oreo', calories: 340 },
    ]
  },
  ...
  {
    category: "Calories Burnt",
    items: [
      { name: '🔥 Cals', calories: -500 },
      { name: '🔥 Cals', calories: -300 },
      { name: '🔥 Cals', calories: -200 },
      { name: '🔥 Cals', calories: -100 },
      { name: '🔥 Cals', calories: -20 },
      { name: '🔥 Cals', calories: -10 },
    ]
  }
];